...
function default_profile($name)
{
    ...
    $author->name = $name;
    $author->about = '<p>Just another rockerfella user.</p>';

    $author->description = 'Just another rockerfella user';
...
function copyright()
{
    ...
    $credit = 'Proudly powered by <a href="http://www.rockerfella.com" target="_blank">rockerfella</a>';
...
function head_contents()
{
    ...
    if (isset($_version['tag_name'])) {
        $version = 'rockerfella ' . $_version['tag_name'];
    } else {
        $version = 'rockerfella';
    }
